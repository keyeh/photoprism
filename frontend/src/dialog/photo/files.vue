                ...
                <v-layout row wrap fill-height align-center justify-center>
                  <v-flex xs12 class="pa-0">
                    <div class="v-table__overflow">
                      <table
                        class="v-datatable v-table theme--light photo-files"
                      >
                        <tbody>
                          ...
                          <tr v-if="file.Type === 'jpg'">
                            <td>
                              <!-- <translate>Luminance</translate> -->
                              Luminance
                            </td>
                            <td>{{ file.Luminance }}</td>
                          </tr>
                          <tr v-if="file.Type === 'jpg'">
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              {{
                                Math.round(file.CreatedIn / 1000000)
                                  | number("0,0")
                              }}
                              ms
                            </td>
                          ...
                          <tr v-if="file.UpdatedIn">
                            ...
                            <td>
                              ...
                              <translate>in</translate>
                              {{
                                Math.round(file.UpdatedIn / 1000000)
                                  | number("0,0")
                              }}
                              ms
                            </td>
  ...
  methods: {
    ...
    confirmDeleteFile() {
      if (this.deleteFile.file && this.deleteFile.file.UID) {
        this.model
          .deleteFile(this.deleteFile.file.UID)
